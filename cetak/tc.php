...
$margin_top = 5; // dalam milimeter
$margin_bottom = 5; // dalam milimeter
$margin_left = 5; // dalam milimeter
$margin_right = 5; // dalam milimeter
$mpdf->SetMargins($margin_left, $margin_right, $margin_top, $margin_bottom);
